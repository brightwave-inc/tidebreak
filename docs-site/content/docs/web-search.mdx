...
key to configure. Gemini models do not offer this in OpenWave today.

**A search provider you configure.** OpenWave calls the search API directly
from your machine.
...
OpenWave's own fetch-and-read path rather than failing.
