---
title: Work mode quickstart
description: Add a provider credential, run your first Work mode task, and get a file out of it.
---

This walks through a first Work mode task: attach a file, let the agent run
code over it, and export what it produces. Switch to **Work** at the top of
the sidebar if you are in Code mode.

For a repository, engine, and pull request, use the
[Code mode quickstart](/code-mode-quickstart).
...
<Cards>
  <Card title="Code mode quickstart" href="/code-mode-quickstart">
    Add a repository, start a workspace, and open a pull request.
  </Card>
