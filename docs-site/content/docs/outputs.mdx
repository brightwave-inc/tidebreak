...
Opening one shows a preview. Charts written as Plotly figures render as
interactive charts with hover and zoom, themed to match the app rather than
using whatever colors the agent chose.
