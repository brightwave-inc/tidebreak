...
profile in another folder keeps its own data and keys. It leaves the worktrees
in `~/Tidebreak` and your repositories alone. Worktrees from before version 0.59
