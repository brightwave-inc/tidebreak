...
To give Tidebreak a standing preference, such as "Answer in British English",
open **Settings → Instructions** and write it under **Personal instructions**.
To give one project a brief, choose **Instructions** from the project's row
menu. Tidebreak follows your personal instructions in every chat, then the
project's instructions in chats filed under it. A change applies from your next
message. Each set holds up to 8,192 bytes.

Instructions reach Tidebreak's own engine. Coding engines such as Claude Code
and Codex read their own instruction files instead.
