...
and goes only to the URL you entered it for. Changing the URL's scheme, host,
port, path, or query drops the stored values, and the editor says so before
you save. Enter them again for the new URL.
