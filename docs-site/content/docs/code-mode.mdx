...
it. Your PATH is not the engine. It still observes that engine's own login —
your Claude or OpenAI subscription stays between you and the tool it belongs
to. **Settings → Coding engines** runs a doctor that reports which engines are
