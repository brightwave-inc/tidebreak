...
The terminal starts with your login shell's environment, and the engines
Tidebreak downloaded come first on its `PATH`. So `claude`, `codex`,
`opencode`, and `grok` there are the same engines your sessions run.
