...
impl ScopedStore {
    ...
    pub async fn get_agent_run_task_plan(
        &self,
        id: AgentRunId,
    ) -> Result<Option<tidebreak_core::AgentRunTaskPlan>> {
    ...
    pub async fn resume_agent_run_from_checkin(
        ...
        id: AgentRunId,
        guidance: Option<&str>,
    ) -> Result<Option<tidebreak_core::AgentRun>> {
    ...
    pub async fn list_agent_run_progress(
        ...
        after_sequence: i64,
        limit: u64,
    ) -> Result<Vec<tidebreak_core::AgentRunProgressEntry>> {
        self.store
    ...
    pub async fn list_inbox_items(&self) -> Result<Vec<tidebreak_core::InboxItem>> {
    ...
    pub async fn list_pending_chat_prompts(
        &self,
    ) -> Result<Vec<tidebreak_core::PendingChatPrompt>> {
        self.store
    ...
    pub async fn list_standing_tool_grants(
        &self,
    ) -> Result<Vec<tidebreak_core::StandingGrantRecord>> {
        self.store
