...
//!
//! This is not a registered Tidebreak client — OpenAI does not offer a
...
//! (`originator=tidebreak`); the OAuth identity is shared.
...
/// no self-serve registration for a distinct Tidebreak client today.
...
pub const ORIGINATOR: &str = "tidebreak";
