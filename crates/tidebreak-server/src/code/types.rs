...
#[allow(unused_imports)] // Compatibility exports keep every generated wire type on this path.
pub use tidebreak_code_delivery::wire::{
...
pub struct DiscardWorkspaceChangesBody {
    /// Every path must have an uncommitted change; a renamed file names both
    /// its paths.
    pub paths: Vec<String>,
}
