//! The in-container Tidebreak sandbox agent.
//!
//! This crate is the sandbox-resident side of the sandbox-provider design's step
//! 7.1: a container image running Tidebreak's agent loop with a closed,
//! sandbox-resident tool registry, behind the versioned
//! [`tidebreak_sandbox_protocol`] wire contract. It is the primary consumer of
