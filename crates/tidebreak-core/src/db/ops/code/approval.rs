...
/// Load one approval by id, whoever owns it.
///
/// A system path for the scoped layer, which has to read the approval's
/// session before it can decide whether the caller may settle it. Nothing
/// answers a route from this directly.
