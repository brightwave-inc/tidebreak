...
pub use code::{
    ...
    CredentialRefusalReason, Diffstat, Event, ExecutionLocation, ExternalMessageRecord,
    ExternalSessionResolution, FileChangeKind, GrantRotation, HarnessCaps, HarnessCommand,
    HarnessKind, HarnessNoticeLevel, HarnessTier, HarnessUpdateChannel, IncarnationAdmission,
    IncarnationState, InternalApprovalRequest, PullRequestCheck, PullRequestCheckBucket,
    PullRequestCheckCounts, PullRequestComment, PullRequestCommentKind, PullRequestDigest,
    QueuedTurn, QuickAction, RepoId, SequencedEvent, Session, SessionAccessLevel, SessionActivity,
    SessionKind, SessionLifecycle, SessionVisibility, ToolDetail, ToolOutcome, Turn, TurnActor,
