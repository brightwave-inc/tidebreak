...
pub use code::{
    ...
    SequencedEvent, Session, SessionActivity, SessionKind, SessionLifecycle, ToolDetail,
    ToolOutcome, Turn, TurnParkWait, TurnStatus, TurnUsage, WorkspaceId, MAX_EVENT_TEXT_CHARS,
