...
pub use code::{
    ...
    CodeBindingId, CodeEvent, CodeExternalBinding, CodeExternalGrant, CodeGrantId,
    ...
    CodeQueuedTurn, CodeRepo, CodeSession, CodeSessionActivity, CodeSessionId,
    CodeSessionIncarnation, CodeSessionKind, CodeSessionLifecycle, CodeSubagentStatus,
    ...
    CodeTriggerFirePayload, CodeTriggerFireState, CodeTriggerId, CodeTurn, CodeTurnId,
    CodeTurnStatus, CodeUsage, CodeWatch, CodeWatchId, CodeWatchState, CodeWorkflowRunFact,
    CodeWorkflowRunId, CodeWorkspace, CodeWorkspaceStatus, Diffstat, ExternalMessageRecord,
    ExternalSessionResolution, FileChangeKind, GrantRotation, HarnessCaps, HarnessCommand,
    HarnessKind, HarnessNoticeLevel, HarnessTier, IncarnationAdmission, IncarnationState,
