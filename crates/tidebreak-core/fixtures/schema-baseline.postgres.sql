CREATE TABLE "project" (
    ...
    "title" text,
    "attachment_revision" bigint NOT NULL DEFAULT 0,
...
CREATE TABLE "chat" (
    ...
    "owner" text NOT NULL DEFAULT 'local', CONSTRAINT "fk_chat_project" FOREIGN KEY ("project_id") REFERENCES "project" ("id") ON DELETE RESTRICT,
    CHECK ("attachment_revision" >= 0),
    CHECK ("attachment_revision" <= 9007199254740991)
);
...
CREATE TABLE "project_root_attachment" (
    ...
    "root_id"), CONSTRAINT "fk_project_root_attachment_project" FOREIGN KEY ("project_id") REFERENCES "project" ("id") ON DELETE CASCADE,
...
CREATE TABLE "chat_root_attachment" (
    ...
    "root_id"), CONSTRAINT "fk_chat_root_attachment_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE,
    CHECK ("root_id" <> '00000000-0000-0000-0000-000000000000'),
    CHECK ("position" >= 0),
    CHECK ("position" < 32),
...
CREATE TABLE "root_attachment_change" (
    ...
    "projection_existed_before" bool NOT NULL,
    ...
    "created_at" timestamp with time zone NOT NULL,
    "finished_at" timestamp with time zone, CONSTRAINT "fk_root_attachment_change_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT,
    ...
    CHECK ("failure_message" IS NULL OR (CHAR_LENGTH("failure_message") BETWEEN 1 AND 256)),
...
CREATE TABLE "message_identity" (
    ...
    "owner" varchar(16) NOT NULL, CONSTRAINT "fk_message_identity_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id"),
...
CREATE TABLE "message" (
    ...
    "reasoning" jsonb,
    "created_at" timestamp with time zone NOT NULL,
    "turn_lease_token" uuid, CONSTRAINT "fk_message_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id")
);
...
CREATE TABLE "blob_retirement" (
    "blob_id" uuid NOT NULL PRIMARY KEY,
    ...
    CHECK ("last_error_detail" IS NULL OR (CHAR_LENGTH("last_error_detail") BETWEEN 1 AND 4096))
);
...
CREATE TABLE "turn_failure" (
    "lease_token" uuid NOT NULL PRIMARY KEY,
    "turn_id" uuid NOT NULL,
    "attempt_count" integer NOT NULL,
    ...
    "result_status" varchar(32) NOT NULL, CONSTRAINT "fk_turn_failure_claim" FOREIGN KEY ("lease_token",
    "turn_id",
    ...
    CHECK ("error_detail" IS NULL OR (CHAR_LENGTH("error_detail") BETWEEN 1 AND 4096))
);
...
CREATE TABLE "agent_run" (
    ...
    "last_error_detail" varchar(4096),
    "origin_turn_id" uuid,
    "delegated_root_id" uuid,
    "delegated_relative_path" text,
    "admitted_at" timestamp with time zone,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "pk_agent_run" PRIMARY KEY ("id",
    "chat_id",
    "depth"), CONSTRAINT "fk_agent_run_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_parent" FOREIGN KEY ("parent_id",
    "chat_id",
    "parent_depth") REFERENCES "agent_run" ("id",
    "chat_id",
    "depth") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_live_claim" FOREIGN KEY ("lease_token",
    "id",
    "attempt_count",
...
CREATE TABLE "agent_run_result" (
    ...
    "payload_json" text NOT NULL DEFAULT E'{\\"text\\":\\"\\"}', CONSTRAINT "fk_agent_run_result_run" FOREIGN KEY ("agent_run_id") REFERENCES "agent_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_result_claim" FOREIGN KEY ("lease_token",
    "agent_run_id",
    "attempt_count",
    "claim_count") REFERENCES "agent_run_claim" ("token",
    "agent_run_id",
    ...
    CHECK ("cache_read_input_tokens" BETWEEN 0 AND 4294967295),
    CHECK ("cache_creation_input_tokens" BETWEEN 0 AND 4294967295),
    CHECK (CHAR_LENGTH("text") BETWEEN 1 AND 65536)
);
...
CREATE TABLE "agent_run_cancellation" (
    ...
    "requested_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_agent_run_cancellation_run" FOREIGN KEY ("agent_run_id") REFERENCES "agent_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_cancellation_claim" FOREIGN KEY ("lease_token",
    "agent_run_id",
    "attempt_count",
    "claim_count") REFERENCES "agent_run_claim" ("token",
    "agent_run_id",
...
CREATE TABLE "agent_run_progress" (
    ...
    "text" text NOT NULL,
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("agent_run_id",
    "sequence"), CONSTRAINT "fk_agent_run_progress_run" FOREIGN KEY ("agent_run_id") REFERENCES "agent_run" ("id") ON DELETE CASCADE,
    CHECK ("sequence" >= 1),
    CHECK (CHAR_LENGTH("text") BETWEEN 1 AND 2048)
);
...
CREATE TABLE "turn_admission" (
    ...
    "lease_expires_at" timestamp with time zone,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_turn_admission_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE,
...
CREATE TABLE "turn_run" (
    ...
    "invoked_skills" jsonb NOT NULL,
    "voice_input_used" bool NOT NULL DEFAULT FALSE,
    "status" varchar(32) NOT NULL DEFAULT 'queued',
    "attempt_count" integer NOT NULL DEFAULT 0,
    "max_attempts" integer NOT NULL DEFAULT 5,
    ...
    "last_error_code" varchar(128),
    "last_error_detail" varchar(4096),
    "steer_revision" bigint NOT NULL DEFAULT 0,
    "last_steer_applied_at" timestamp with time zone,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_turn_run_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE, CONSTRAINT "fk_turn_run_foreground_agent" FOREIGN KEY ("agent_run_id",
    "chat_id",
    "agent_run_depth") REFERENCES "agent_run" ("id",
    "chat_id",
    "depth") ON DELETE RESTRICT, CONSTRAINT "fk_turn_run_input_message" FOREIGN KEY ("input_message_id",
    "chat_id",
    "id") REFERENCES "message" ("id",
    "chat_id",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_run_output_message" FOREIGN KEY ("output_message_id",
    "chat_id",
    "id") REFERENCES "message" ("id",
    "chat_id",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_run_live_claim" FOREIGN KEY ("lease_token",
    "id",
    "attempt_count",
    ...
    "attempt_count",
    "claim_count") ON DELETE RESTRICT,
    CHECK (CHAR_LENGTH("model") BETWEEN 1 AND 512),
...
CREATE TABLE "queued_turn" (
    ...
    "position" integer NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_queued_turn_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE,
...
CREATE TABLE "event" (
    ...
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("chat_id",
    "seq"), CONSTRAINT "fk_event_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id"), CONSTRAINT "fk_event_turn" FOREIGN KEY ("chat_id",
    "turn_id") REFERENCES "turn_run" ("chat_id",
    "id") ON DELETE RESTRICT, CONSTRAINT "fk_event_turn_claim" FOREIGN KEY ("turn_id",
...
CREATE TABLE "agent_run_inbox" (
    "child_run_id" uuid NOT NULL PRIMARY KEY,
    "parent_run_id" uuid NOT NULL,
    "chat_id" uuid NOT NULL,
    "parent_depth" smallint NOT NULL,
    "result_lease_token" uuid NOT NULL,
    ...
    "consumed_lease_token" uuid NULL,
    "consumed_at" timestamp with time zone NULL,
    "delivered_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_agent_run_inbox_child" FOREIGN KEY ("child_run_id",
    "parent_run_id",
    "chat_id") REFERENCES "agent_run" ("id",
    "parent_id",
    "chat_id") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_inbox_parent" FOREIGN KEY ("parent_run_id",
    "chat_id",
    "parent_depth") REFERENCES "agent_run" ("id",
    "chat_id",
    "depth") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_inbox_result" FOREIGN KEY ("child_run_id",
    "result_lease_token",
...
CREATE TABLE "turn_steer" (
    ...
    "invoked_skills" jsonb NOT NULL,
    "voice_input_used" bool NOT NULL DEFAULT FALSE,
    "interrupt" bool NOT NULL DEFAULT FALSE,
    "status" varchar(16) NOT NULL DEFAULT 'pending',
    "applied_lease_token" uuid,
    "message_id" uuid,
    "preceding_assistant_message_id" uuid,
    "created_at" timestamp with time zone NOT NULL,
    "resolved_at" timestamp with time zone, CONSTRAINT "fk_turn_steer_turn" FOREIGN KEY ("chat_id",
    "turn_id") REFERENCES "turn_run" ("chat_id",
    "id") ON DELETE CASCADE, CONSTRAINT "fk_turn_steer_preceding_assistant" FOREIGN KEY ("preceding_assistant_message_id",
    "chat_id",
    "turn_id") REFERENCES "message" ("id",
    "chat_id",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_steer_claim" FOREIGN KEY ("applied_lease_token",
    "turn_id") REFERENCES "turn_claim" ("token",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_steer_message" FOREIGN KEY ("message_id",
    "chat_id",
    "turn_id") REFERENCES "message" ("id",
    "chat_id",
...
CREATE TABLE "tool_call" (
    ...
    "approval_event_seq" bigint,
    "client_executor_id" uuid,
    "client_lease_token" uuid,
    "client_lease_expires_at" timestamp with time zone,
    "created_at" timestamp with time zone NOT NULL,
    "resolved_at" timestamp with time zone,
    "turn_lease_token" uuid,
    "resolution_turn_lease_token" uuid,
    "approval_grant_source_call_id" uuid,
    "result_preview" jsonb,
    "provider_replay" jsonb,
    "auto_judge_status" text,
    "raw_arguments" text, CONSTRAINT "fk_tool_call_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id"), CONSTRAINT "fk_tool_call_approval_event" FOREIGN KEY ("chat_id",
    ...
    CHECK ("result" IS NULL OR CHAR_LENGTH("result") <= 524288),
    ...
    CHECK ("approval_reason" IS NULL OR (CHAR_LENGTH("approval_reason") BETWEEN 1 AND 512)),
...
CREATE TABLE "standing_tool_grant" (
    "source_call_id" uuid NOT NULL PRIMARY KEY,
    "chat_id" uuid,
    "tool_name" text NOT NULL,
    "approval_kind" varchar(64) NOT NULL,
    "scope" jsonb NOT NULL,
    "granted_at" timestamp with time zone NOT NULL,
    "project_id" uuid, CONSTRAINT "fk_standing_tool_grant_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE, CONSTRAINT "fk_standing_tool_grant_project" FOREIGN KEY ("project_id") REFERENCES "project" ("id") ON DELETE CASCADE,
    CHECK (CHAR_LENGTH("tool_name") BETWEEN 1 AND 256),
...
CREATE TABLE "operation_log" (
    ...
    "state" varchar(16) NOT NULL,
    "fingerprint" bytea NOT NULL,
    "external_effect" bool NOT NULL,
    "owner_epoch" uuid NOT NULL,
    "body" bytea NULL,
    "retained" bool NOT NULL DEFAULT TRUE,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "pk_operation_log" PRIMARY KEY ("run_id",
    "operation_id"),
...
CREATE TABLE "plan_request" (
    ...
    "resolved_at" timestamp with time zone, CONSTRAINT "fk_plan_request_call" FOREIGN KEY ("call_id") REFERENCES "tool_call" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_plan_request_turn" FOREIGN KEY ("turn_id") REFERENCES "turn_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_plan_request_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_plan_request_event" FOREIGN KEY ("chat_id",
...
CREATE TABLE "task_plan" (
    ...
    "steps" text NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_task_plan_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_task_plan_turn" FOREIGN KEY ("turn_id") REFERENCES "turn_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_task_plan_call" FOREIGN KEY ("call_id") REFERENCES "tool_call" ("id") ON DELETE RESTRICT,
    CHECK ("updated_at" >= "created_at")
);
...
CREATE TABLE "user_question_request" (
    ...
    "resolved_at" timestamp with time zone,
    "additional_user_context" varchar(2000), CONSTRAINT "fk_user_question_request_call" FOREIGN KEY ("call_id") REFERENCES "tool_call" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_user_question_request_turn" FOREIGN KEY ("turn_id") REFERENCES "turn_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_user_question_request_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_user_question_request_event" FOREIGN KEY ("chat_id",
    "event_seq") REFERENCES "event" ("chat_id",
    "seq") ON DELETE RESTRICT,
...
CREATE TABLE "user_question" (
    ...
    "allow_free_form" bool NOT NULL,
    "question_type" varchar(16) NOT NULL DEFAULT 'single_select',
    "answer_selected_option_ids" jsonb,
    "answer_custom_answer" varchar(2000),
    "response_recorded_at" timestamp with time zone, CONSTRAINT "pk_user_question" PRIMARY KEY ("call_id",
    "question_id"), CONSTRAINT "fk_user_question_request" FOREIGN KEY ("call_id") REFERENCES "user_question_request" ("call_id") ON DELETE RESTRICT,
...
CREATE TABLE "turn_client_wait" (
    ...
    "turn_id" uuid NOT NULL,
    "chat_id" uuid NOT NULL,
    "park_lease_token" uuid NOT NULL,
    "attempt_count" integer NOT NULL,
    "claim_count" integer NOT NULL,
    "model_steps" integer NOT NULL,
    "input_tokens" bigint NOT NULL,
    ...
    "closed_at" timestamp with time zone, CONSTRAINT "fk_turn_client_wait_call" FOREIGN KEY ("call_id",
    "chat_id",
    "turn_id") REFERENCES "tool_call" ("id",
    "chat_id",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_client_wait_claim" FOREIGN KEY ("park_lease_token",
    "turn_id",
    "attempt_count",
    "claim_count") REFERENCES "turn_claim" ("token",
    "turn_id",
...
CREATE TABLE "context_checkpoint" (
    ...
    "output_tokens" bigint NOT NULL DEFAULT 0,
    "cache_read_input_tokens" bigint NOT NULL DEFAULT 0,
    "cache_creation_input_tokens" bigint NOT NULL DEFAULT 0, CONSTRAINT "fk_context_checkpoint_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE, CONSTRAINT "fk_context_checkpoint_source_message" FOREIGN KEY ("source_message_id") REFERENCES "message" ("id") ON DELETE RESTRICT,
...
CREATE TABLE "document" (
    ...
    "source_blob_id" uuid,
    "source_sha256" bytea,
    "source_byte_len" bigint,
    "canonical_text" text NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL,
    "owner" text NOT NULL DEFAULT 'local', CONSTRAINT "fk_document_project" FOREIGN KEY ("project_id") REFERENCES "project" ("id") ON DELETE RESTRICT,
...
CREATE TABLE "output" (
    ...
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL,
    "deleted_at" timestamp with time zone, CONSTRAINT "fk_output_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE,
...
CREATE TABLE "output_revision" (
    ...
    "created_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_output_revision_output" FOREIGN KEY ("output_id") REFERENCES "output" ("id") ON DELETE CASCADE,
...
CREATE TABLE "assistant_citation" (
    ...
    "locator" jsonb NOT NULL, CONSTRAINT "idx_assistant_citation_light_message_ordinal" UNIQUE ("message_id",
    "ordinal"), CONSTRAINT "fk_assistant_citation_light_message" FOREIGN KEY ("message_id") REFERENCES "message" ("id") ON DELETE CASCADE, CONSTRAINT "fk_assistant_citation_light_document" FOREIGN KEY ("document_id") REFERENCES "document" ("id") ON DELETE CASCADE
);
...
CREATE TABLE "chat_image_publication" (
    ...
    "byte_len" bigint NOT NULL,
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("chat_id",
    "blob_id"), CONSTRAINT "fk_chat_image_publication_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT,
...
CREATE TABLE "message_attachment" (
    ...
    "height" integer NOT NULL,
    "byte_len" bigint NOT NULL,
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("message_id",
    "ordinal"), CONSTRAINT "fk_message_attachment_message" FOREIGN KEY ("message_id") REFERENCES "message" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_message_attachment_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT,
    CHECK ("blob_id" <> '00000000-0000-0000-0000-000000000000'),
    CHECK ("ordinal" >= 0),
    CHECK ("ordinal" < 16),
    CHECK ("media_type" IN ('image/png', 'image/jpeg', 'image/webp', 'image/gif')),
...
CREATE TABLE "message_document_attachment" (
    ...
    "document_id" uuid NOT NULL,
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("message_id",
    "ordinal"), CONSTRAINT "fk_message_document_attachment_message" FOREIGN KEY ("message_id") REFERENCES "message" ("id") ON DELETE CASCADE, CONSTRAINT "fk_message_document_attachment_document" FOREIGN KEY ("document_id") REFERENCES "document" ("id") ON DELETE CASCADE, CONSTRAINT "fk_message_document_attachment_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE CASCADE,
...
CREATE TABLE "app_revision" (
    ...
    "producing_run_id" uuid,
    "chat_id" uuid,
    "created_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_app_revision_app" FOREIGN KEY ("app_id") REFERENCES "app" ("id") ON DELETE CASCADE,
    CHECK ("ordinal" BETWEEN 1 AND 100),
...
CREATE TABLE "app_grant" (
    ...
    "created_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_app_grant_app" FOREIGN KEY ("app_id") REFERENCES "app" ("id") ON DELETE CASCADE
);
...
CREATE TABLE "app_gateway_draft" (
    ...
    "synced_revision_id" uuid NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, PRIMARY KEY ("app_id",
    "gateway_base_url"), CONSTRAINT "fk_app_gateway_draft_app" FOREIGN KEY ("app_id") REFERENCES "app" ("id") ON DELETE CASCADE,
...
CREATE TABLE "sandbox_tool_call" (
    ...
    "executor_lease_expires_at" timestamp with time zone,
    "retry_at" timestamp with time zone,
    "resolution_lease_token" uuid,
    "result" text,
    "error_code" text,
    "error_detail" text,
    "created_at" timestamp with time zone NOT NULL,
    "resolved_at" timestamp with time zone, CONSTRAINT "fk_sandbox_tool_call_run" FOREIGN KEY ("agent_run_id",
    "chat_id",
    "agent_run_depth") REFERENCES "agent_run" ("id",
    "chat_id",
    "depth") ON DELETE RESTRICT, CONSTRAINT "fk_sandbox_tool_call_park_claim" FOREIGN KEY ("park_lease_token",
    "agent_run_id",
    "park_attempt_count",
...
CREATE TABLE "sandbox_spawn_checkpoint" (
    "call_id" uuid NOT NULL PRIMARY KEY,
    "child_run_id" uuid NOT NULL UNIQUE,
    "parent_run_id" uuid NOT NULL,
    ...
    "remaining_requests" jsonb NOT NULL,
    "steer_revision" bigint NOT NULL,
    ...
    "cache_creation_input_tokens" bigint NOT NULL,
    "event_seq" bigint NOT NULL,
    "committed_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_sandbox_spawn_checkpoint_admission" FOREIGN KEY ("child_run_id",
    "origin_turn_id",
    "parent_run_id",
    "chat_id") REFERENCES "agent_run" ("id",
    "origin_turn_id",
    "parent_id",
    "chat_id") ON DELETE RESTRICT, CONSTRAINT "fk_sandbox_spawn_checkpoint_claim" FOREIGN KEY ("lease_token",
    "origin_turn_id",
    "attempt_count",
    "claim_count") REFERENCES "turn_claim" ("token",
    "turn_id",
    "attempt_count",
    "claim_count") ON DELETE RESTRICT, CONSTRAINT "fk_sandbox_spawn_checkpoint_tool" FOREIGN KEY ("call_id",
    "chat_id",
    "history_order") REFERENCES "tool_call" ("id",
    "chat_id",
    "history_order") ON DELETE RESTRICT, CONSTRAINT "fk_sandbox_spawn_checkpoint_event" FOREIGN KEY ("chat_id",
    "event_seq") REFERENCES "event" ("chat_id",
    "seq") ON DELETE RESTRICT,
    CHECK ("attempt_count" >= 1),
    CHECK ("claim_count" >= "attempt_count"),
    ...
    CHECK ("cache_creation_input_tokens" BETWEEN 0 AND 4294967295),
    CHECK (CHAR_LENGTH("provider_id") BETWEEN 1 AND 256),
    CHECK (CHAR_LENGTH("result") <= 524288)
);
...
CREATE TABLE "agent_run_task_plan" (
    ...
    "steps" text NOT NULL,
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_agent_run_task_plan_run" FOREIGN KEY ("agent_run_id") REFERENCES "agent_run" ("id") ON DELETE RESTRICT, CONSTRAINT "fk_agent_run_task_plan_call" FOREIGN KEY ("call_id") REFERENCES "sandbox_tool_call" ("id") ON DELETE RESTRICT,
    CHECK ("updated_at" >= "created_at")
);
...
CREATE TABLE "exec_file_change" (
    ...
    "prior_blob_id" uuid NULL,
    "prior_byte_len" bigint NULL,
    "new_sha256" varchar(64) NULL,
    "undo_state" varchar(32) NULL,
    "reason" varchar(32) NULL,
    "recorded_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_exec_file_change_chat" FOREIGN KEY ("chat_id") REFERENCES "chat" ("id") ON DELETE RESTRICT,
...
CREATE TABLE "turn_agent_run_wait_set" (
    ...
    "park_lease_token" uuid NOT NULL,
    "expected_steer_revision" bigint NOT NULL,
    "attempt_count" integer NOT NULL,
    "claim_count" integer NOT NULL,
    "model_steps" integer NOT NULL,
    "input_tokens" bigint NOT NULL,
    ...
    "resume_token" uuid, CONSTRAINT "fk_turn_agent_run_wait_set_turn" FOREIGN KEY ("turn_id",
    "chat_id",
    "parent_run_id") REFERENCES "turn_run" ("id",
    "chat_id",
    "agent_run_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_agent_run_wait_set_tool" FOREIGN KEY ("id",
    "chat_id",
    "turn_id") REFERENCES "tool_call" ("id",
    "chat_id",
    "turn_id") ON DELETE RESTRICT, CONSTRAINT "fk_turn_agent_run_wait_set_event" FOREIGN KEY ("chat_id",
    "event_seq") REFERENCES "event" ("chat_id",
    "seq") ON DELETE RESTRICT, CONSTRAINT "fk_turn_agent_run_wait_set_claim" FOREIGN KEY ("park_lease_token",
    "turn_id",
    "attempt_count",
    "claim_count") REFERENCES "turn_claim" ("token",
    "turn_id",
...
CREATE TABLE "turn_agent_run_wait_member" (
    ...
    "origin_turn_id" uuid NOT NULL,
    "chat_id" uuid NOT NULL,
    "open" bool NOT NULL, PRIMARY KEY ("wait_id",
    "position"), CONSTRAINT "fk_turn_agent_run_wait_member_set" FOREIGN KEY ("wait_id",
    "origin_turn_id",
    "parent_run_id",
    "chat_id") REFERENCES "turn_agent_run_wait_set" ("id",
    "turn_id",
    "parent_run_id",
    "chat_id") ON DELETE CASCADE, CONSTRAINT "fk_turn_agent_run_wait_member_admission" FOREIGN KEY ("child_run_id",
    "origin_turn_id",
    "parent_run_id",
    "chat_id") REFERENCES "agent_run" ("id",
    "origin_turn_id",
...
CREATE TABLE "code_workspace" (
    ...
    "released_tip" text,
    "bundle_bytes" bigint, CONSTRAINT "fk_code_workspace_repo" FOREIGN KEY ("repo_id") REFERENCES "code_repo" ("id"),
...
CREATE TABLE "code_session" (
    ...
    "fence_reason" jsonb,
    "child_pid" bigint,
    "spawn_epoch" bigint NOT NULL DEFAULT 0,
    "attention_state" jsonb NOT NULL,
    "attention_source" text NOT NULL,
    "unrecognized_event_count" bigint NOT NULL DEFAULT 0,
    "subagents" jsonb,
    "created_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_code_session_workspace" FOREIGN KEY ("workspace_id") REFERENCES "code_workspace" ("id"),
...
CREATE TABLE "code_turn" (
    ...
    "user_input_blob_id" uuid,
    "checkpoint_ref" text,
    "diffstat" jsonb,
    "usage" jsonb,
    "narrative" text,
    "started_at" timestamp with time zone NOT NULL,
    "ended_at" timestamp with time zone, CONSTRAINT "fk_code_turn_session" FOREIGN KEY ("session_id") REFERENCES "code_session" ("id"),
...
CREATE TABLE "code_event" (
    ...
    "created_at" timestamp with time zone NOT NULL, PRIMARY KEY ("session_id",
    "seq"), CONSTRAINT "fk_code_event_session" FOREIGN KEY ("session_id") REFERENCES "code_session" ("id"),
    CHECK ("seq" >= 1)
);
...
CREATE TABLE "code_approval" (
    ...
    "turn_id" uuid NOT NULL,
    "kind" jsonb NOT NULL,
    "harness_raw" jsonb NOT NULL,
    "state" text NOT NULL,
    "feedback" text,
    "requested_at" timestamp with time zone NOT NULL,
    "decided_at" timestamp with time zone, CONSTRAINT "fk_code_approval_session" FOREIGN KEY ("session_id") REFERENCES "code_session" ("id"), CONSTRAINT "fk_code_approval_turn" FOREIGN KEY ("turn_id") REFERENCES "code_turn" ("id"),
...
CREATE TABLE "code_watch" (
    ...
    "created_at" timestamp with time zone NOT NULL,
    "updated_at" timestamp with time zone NOT NULL, CONSTRAINT "fk_code_watch_workspace" FOREIGN KEY ("workspace_id") REFERENCES "code_workspace" ("id"), CONSTRAINT "fk_code_watch_session" FOREIGN KEY ("session_id") REFERENCES "code_session" ("id"),
