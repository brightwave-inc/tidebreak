...
use crate::model::{
    AgentRunExecution, AgentRunStatus, SandboxToolCall, SandboxToolCallReceipt,
    SandboxToolCallRequest, SandboxToolCallStatus, ToolCallRecord, ToolCallResolution,
};
use crate::storage::{
    ClaimSandboxToolCallOutcome, ParkSandboxToolCallOutcome, ResolveSandboxToolCallOutcome,
};
...
pub(in crate::db) async fn park_agent_run_for_sandbox_tool_call(
    ...
    if lease_token.is_nil() || !call.is_well_formed() || call.agent_run_id != agent_run_id {
