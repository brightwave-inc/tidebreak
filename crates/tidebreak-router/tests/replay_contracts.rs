...
//!
//! ```text
//! UPDATE_FIXTURES=1 cargo test -p tidebreak-router --test replay_contracts
//! git diff crates/tidebreak-router/tests/fixtures
//! ```
//!
...
use tidebreak_core::model::ReasoningEffort;
use tidebreak_core::{
...
use tidebreak_router::{AnthropicProvider, GeminiProvider, OpenAiCompatProvider, OpenAiProvider};
