...
//! | Variable | Default |
//! |---|---|
//! | `TIDEBREAK_PROVIDER_CONNECT_TIMEOUT_SECS` | 10 |
//! | `TIDEBREAK_PROVIDER_READ_TIMEOUT_SECS` | 300 |
//! | `TIDEBREAK_PROVIDER_STREAM_TIMEOUT_SECS` | 3600 |
//!
...
use tidebreak_core::error::Result;
    ...
    pub fn from_env() -> Self {
        Self {
            connect: env_duration(
                "TIDEBREAK_PROVIDER_CONNECT_TIMEOUT_SECS",
                DEFAULT_CONNECT_TIMEOUT,
            ),
            dead_air: env_duration("TIDEBREAK_PROVIDER_READ_TIMEOUT_SECS", DEFAULT_READ_TIMEOUT),
            total_stream: env_duration(
                "TIDEBREAK_PROVIDER_STREAM_TIMEOUT_SECS",
