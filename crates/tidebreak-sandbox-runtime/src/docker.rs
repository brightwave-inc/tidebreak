...
// Manifest-list digest of ghcr.io/brightwave-inc/tidebreak-sandbox-agent-documents:main-20260914-6e44572-r1377,
// published by workflow run 34884331591 (push, 2026-09-14); the run's
// step summary records the same value from a post-push `imagetools inspect`.
const PUBLISHED_IMAGE_DIGEST: Option<&str> =
    Some("sha256:9ac90357cb9c84a473c6c8533c8a2bfddf149211501094bae4cb2c115b13199e");
