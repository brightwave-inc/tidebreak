...
// Manifest-list digest of ghcr.io/brightwave-inc/tidebreak-sandbox-agent-documents:main-20260910-2e875e5-r1324,
// published by workflow run 34511151839 (push, 2026-09-10); the run's
// step summary records the same value from a post-push `imagetools inspect`.
const PUBLISHED_IMAGE_DIGEST: Option<&str> =
    Some("sha256:bfbfbf2b8ff18b7c76e8f37e4bbbb250d014049abe700cd0a061131b104070e1");
