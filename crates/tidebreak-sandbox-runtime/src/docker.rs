...
// Manifest-list digest of ghcr.io/brightwave-inc/tidebreak-sandbox-agent-documents:main-20260917-385cefe-r1431,
// published by workflow run 35183317098 (schedule, 2026-09-17); the run's
// step summary records the same value from a post-push `imagetools inspect`.
const PUBLISHED_IMAGE_DIGEST: Option<&str> =
    Some("sha256:9b274c9cb36a16f4fd9d58caf71ae9b565e9c26a6f2659dbc59d5cd8f0a2bfc3");
