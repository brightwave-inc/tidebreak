...
export const SLASH_COMMANDS: readonly SlashCommand[] = [
  {
    name: "usage",
    description: "Show this conversation's context and token usage.",
    takesArgument: false,
  },
  {
    name: "compact",
    description:
      "Summarize the earlier part of this conversation now. Add what to keep: /compact the API design",
    takesArgument: true,
  },
];
