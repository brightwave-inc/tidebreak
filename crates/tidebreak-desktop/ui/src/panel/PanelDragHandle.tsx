...
export function PanelDragHandle({
  ...
  return (
    ...
    >
      ...
      <div className="relative h-6 w-2 cursor-col-resize rounded-full border-[0.5px] border-border bg-background shadow transition duration-200 group-hover:border-foreground/10 group-hover:bg-muted group-hover:delay-75 group-data-[separator=active]:bg-foreground" />
    </Separator>
  );
}
