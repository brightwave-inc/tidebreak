...
const live: CodeGrantSnapshot = {
  ...
  channel_kind: "slack",
  external_identity: "Casey Nakamura",
  workspace_identity: "Acme Corp",
...
const stolen: CodeGrantSnapshot = {
  ...
  channel_kind: "slack",
  external_identity: "Jordan Reyes",
  workspace_identity: "Nightside Labs",
