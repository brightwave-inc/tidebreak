...
function inspectorClient(scenario: InspectorScenario): ApiClient {
  ...
  return {
    ...
    getCodeDeliveryPullRequestDetail: async () => ({
      summary: {
        id: "github.com/example/tidebreak#2248",
        repository: {
          host: "github.com",
          owner: "example",
          name: "tidebreak",
          name_with_owner: "example/tidebreak",
          url: "https://github.com/example/tidebreak",
        },
        number: 2248,
        url: "https://github.com/example/tidebreak/pull/2248",
        ...
        state: "open",
        draft: false,
        head_branch: pullRequest.head_branch ?? "main",
        base_branch: pullRequest.base_branch ?? "main",
      ...
      body: "Conversation-first workspace panes.",
      labels: [],
      assignees: [],
      requested_reviewers: [],
      changed_files: 6,
