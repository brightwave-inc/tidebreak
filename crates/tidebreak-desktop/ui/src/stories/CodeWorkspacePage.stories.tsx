  ...
  return {
    ...
    getCodeDeliveryPullRequestDetail: async () => ({
      summary: {
        ...
        head_branch: prSnapshot.pr?.head_branch ?? workspace.branch_name,
        base_branch: prSnapshot.pr?.base_branch ?? "main",
