...
impl tidebreak_code_execution::HostToolBroker for DesktopHostToolBroker {
    ...
    async fn status(
        &self,
        tool: tidebreak_code_execution::HostDep,
    ) -> tidebreak_code_execution::HostToolStatus {
        match tool {
            tidebreak_code_execution::HostDep::LibreOffice => libreoffice_status(&self.app).await,
            tidebreak_code_execution::HostDep::Node => crate::node_install::status(&self.app).await,
        }
    }
    ...
    async fn managed_root(
        ...
        match tool {
            ...
            // downstream needs.
            tidebreak_code_execution::HostDep::LibreOffice => None,
...
async fn libreoffice_status(app: &AppHandle) -> tidebreak_code_execution::HostToolStatus {
