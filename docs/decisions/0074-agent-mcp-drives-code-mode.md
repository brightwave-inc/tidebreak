...
- Date: 2026-08-26
- Owners: cli
- Related: [`0071-agent-mcp-drives-chat-over-attach.md`](0071-agent-mcp-drives-chat-over-attach.md),
...
The chat decision (record 71; an in-flight PR may renumber it to 73) already
